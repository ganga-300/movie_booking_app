import { LayoutDashboardIcon, ListCollapseIcon, PlusSquareIcon ,ListIcon, LinkIcon} from 'lucide-react'
  ...
  return (
    ...
    <div className='w-full'>
        {adminNavlinks.map((link,index)=>
            (<NavLink key={index} to={link.path} className={({isActive})=> `relative flex items-center max-md:justify-center gap-2 w-full py-2.5 min-md:pl-10 first:mt-6
